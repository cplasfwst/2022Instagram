...
func Fa_First() chromedp.ActionFunc {
	return func(ctx context.Context) (err error) {
		...
		fmt.Println("已经完成点击1")
		//点击继续按钮
		chromedp.WaitVisible(`body > div.RnEpo.gpWnf.Yx5HN > div.pbNvD > div > div > div > div.uYzeu > div._C8iK > div > div > div > div:nth-child(4)`, chromedp.ByQuery).Do(ctx)
